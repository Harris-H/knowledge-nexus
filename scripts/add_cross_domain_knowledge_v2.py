...
NODES = [
    ...
    },
    {
        ...
        "year": 1938, "tags": "强化学习,斯金纳,操作性条件反射,奖励,惩罚",
    },
    {
        "name": "认知偏差与启发式",
        "node_type": "phenomenon", "domain": "psychology",
        ...
        "year": 1974, "tags": "认知偏差,启发式,Kahneman,双系统,决策",
    },
    {
        "name": "遗忘曲线与间隔重复",
        "node_type": "phenomenon", "domain": "psychology",
        ...
        "year": 1885, "tags": "遗忘曲线,间隔重复,记忆,艾宾浩斯,学习",
    },

    # ── 化学 ──
    {
        "name": "催化作用",
        "node_type": "phenomenon", "domain": "chemistry",
        ...
        "year": 1835, "tags": "催化,活化能,加速,酶,反应速率",
    },
    {
        "name": "分子自组装",
        "node_type": "phenomenon", "domain": "chemistry",
        ...
        "year": None, "tags": "自组装,涌现,自组织,有序,分子",
    },

    # ── 生态学 ──
    {
        "name": "捕食者-猎物动力学（Lotka-Volterra）",
        "node_type": "phenomenon", "domain": "ecology",
        ...
        "year": 1925, "tags": "捕食者,猎物,振荡,动态平衡,种群",
    },
    {
        "name": "生态位分化与共存",
        "node_type": "principle", "domain": "ecology",
        ...
        "year": 1934, "tags": "生态位,竞争排斥,分化,共存,多样性",
    },

    # ── 哲学 / 方法论 ──
    {
        "name": "奥卡姆剃刀",
        "node_type": "principle", "domain": "philosophy",
        ...
        "year": 1320, "tags": "奥卡姆,简约,正则化,模型选择,MDL",
    },
    {
        "name": "涌现与还原论",
        "node_type": "concept", "domain": "philosophy",
        ...
        "year": 1972, "tags": "涌现,还原论,复杂性,层次,自组织",
    },
    {
        "name": "类比推理",
        "node_type": "method", "domain": "philosophy",
        ...
        "year": 1983, "tags": "类比,迁移,结构映射,创造力,知识迁移",
    },

    # ── 社会学 / 复杂系统 ──
    {
        "name": "六度分隔与小世界网络",
        "node_type": "phenomenon", "domain": "sociology",
        ...
        "year": 1967, "tags": "六度分隔,小世界,社交网络,图论,连通性",
    },
    {
        "name": "马太效应（富者愈富）",
        "node_type": "phenomenon", "domain": "sociology",
        ...
        "year": 1968, "tags": "马太效应,幂律,优先连接,正反馈,无标度",
    },

    # ── 信息论 / 控制论 ──
    {
        "name": "信息瓶颈理论",
        "node_type": "theorem", "domain": "computer_science",
        ...
        "year": 1999, "tags": "信息瓶颈,Tishby,压缩,表示学习,互信息",
    },
    {
        "name": "控制论（Cybernetics）",
        "node_type": "concept", "domain": "engineering",
        ...
        "year": 1948, "tags": "控制论,维纳,反馈,信息,自我调节,AI起源",
    },
    ...
    # ── 物理 / 数学 补充 ──
    {
        ...
        "year": 1963, "tags": "混沌,蝴蝶效应,敏感依赖,洛伦兹,非线性",
    },
    {
        "name": "傅里叶变换",
        ...
        "year": 1822, "tags": "傅里叶,频域,信号处理,FFT,频谱",
    },
    {
        "name": "蒙特卡洛方法",
        "node_type": "method", "domain": "mathematics",
        ...
        "year": 1946, "tags": "蒙特卡洛,随机抽样,MCMC,AlphaGo,模拟",
    },
    ...
    # ── 计算机补充 ──
    {
        ...
        "year": 1998, "tags": "强化学习,RL,Q-learning,PPO,AlphaGo,RLHF",
    },
    {
        "name": "迁移学习",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2010, "tags": "迁移学习,预训练,微调,知识复用,domain adaptation",
    },
]
...
print(f"\n按领域分布:")
for row in cur.execute("SELECT domain, COUNT(*) FROM knowledge_nodes GROUP BY domain ORDER BY COUNT(*) DESC"):
    print(f"  {row[0]}: {row[1]}")
conn.close()
