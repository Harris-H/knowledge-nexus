...
NODES = [
    {
        ...
        "year": 1982, "tags": "ASR,语音识别,端到端,CTC,Whisper,Conformer",
    },
    {
        "name": "语音合成 (TTS)",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2016, "tags": "TTS,语音合成,声码器,WaveNet,Tacotron,VALL-E",
    },
    {
        "name": "语音自监督学习",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2020, "tags": "自监督,语音表示,Wav2Vec,HuBERT,预训练,对比学习",
    },
    {
        "name": "CTC (连接时序分类)",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2006, "tags": "CTC,序列对齐,端到端,blank标签,Graves",
    },
    {
        "name": "声码器 (Vocoder)",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2016, "tags": "声码器,Vocoder,WaveNet,HiFi-GAN,波形生成,梅尔频谱",
    },
    {
        ...
        "year": 2021, "tags": "音频编解码,EnCodec,SoundStream,RVQ,向量量化,离散化",
    },
    {
        ...
        "year": 2022, "tags": "语音大模型,Speech LLM,AudioLM,VALL-E,通用语音",
    },
    {
        ...
        "year": 2023, "tags": "语音克隆,零样本,VALL-E,GPT-SoVITS,说话人嵌入,伦理",
    },
    {
        ...
        "year": 2022, "tags": "音频生成,AudioLDM,MusicLM,Suno,文字转音频",
    },
    {
        ...
        "year": 2020, "tags": "Conformer,混合架构,CNN,Transformer,ASR,局部+全局",
    },
    {
        "name": "说话人验证与声纹识别",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2017, "tags": "声纹识别,说话人验证,x-vector,ECAPA-TDNN,speaker embedding",
    },
    {
        "name": "语音情感识别 (SER)",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2009, "tags": "情感识别,SER,情绪,语音特征,MFCC,效价唤醒",
    },
]
...
PAPERS = [
    {
        ...
        "year": 2016, "citation_count": 7500, "venue": "arXiv / SSW 2016",
        "doi": None, "arxiv_id": "1609.03499",
    ...
    },
    {
        ...
        "year": 2018, "citation_count": 4200, "venue": "ICASSP 2018",
        "doi": None, "arxiv_id": "1712.05884",
    ...
    },
    {
        ...
        "year": 2020, "citation_count": 4500, "venue": "NeurIPS 2020",
        "doi": None, "arxiv_id": "2006.11477",
    ...
    },
    {
        ...
        "year": 2021, "citation_count": 1200, "venue": "IEEE/ACM TASLP 2021",
        "doi": None, "arxiv_id": "2106.07447",
    ...
    },
    {
        ...
        "year": 2022, "citation_count": 2200, "venue": "ICML 2023",
        "doi": None, "arxiv_id": "2212.04356",
    ...
    },
    {
        ...
        "year": 2020, "citation_count": 2700, "venue": "INTERSPEECH 2020",
        "doi": None, "arxiv_id": "2005.08100",
    ...
    },
    {
        ...
        "year": 2022, "citation_count": 400, "venue": "arXiv 2022",
        "doi": None, "arxiv_id": "2209.03143",
    ...
    },
    {
        ...
        "year": 2023, "citation_count": 500, "venue": "arXiv 2023",
        "doi": None, "arxiv_id": "2301.02111",
    ...
    },
    {
        ...
        "year": 2022, "citation_count": 350, "venue": "TMLR 2023",
        "doi": None, "arxiv_id": "2210.13438",
    ...
    },
    {
        ...
        "year": 2023, "citation_count": 80, "venue": "arXiv 2023",
        "doi": None, "arxiv_id": "2305.09636",
    ...
    },
    {
        ...
        "year": 2016, "citation_count": 3500, "venue": "ICML 2016",
        "doi": None, "arxiv_id": "1512.02595",
    ...
    },
    {
        ...
        "year": 2020, "citation_count": 1800, "venue": "NeurIPS 2020",
        "doi": None, "arxiv_id": "2010.05646",
    ...
    },
    {
        ...
        "year": 2024, "citation_count": 100, "venue": "GitHub/Open Source",
    ...
    },
    {
        ...
        "year": 2024, "citation_count": 50, "venue": "arXiv 2024",
        "doi": None, "arxiv_id": "2407.05407",
    ...
    },
    {
        ...
        "year": 2024, "citation_count": 30, "venue": "GitHub/Open Source",
        "doi": None, "arxiv_id": None,
    ...
    },
    {
        ...
        "year": 2024, "citation_count": 20, "venue": "GitHub/Open Source",
        "doi": None, "arxiv_id": None,
    ...
    },
    {
        ...
        "year": 2023, "citation_count": 200, "venue": "arXiv 2023 (Meta AI)",
        "doi": None, "arxiv_id": "2306.15687",
    ...
    },
    {
        ...
        "year": 2023, "citation_count": 300, "venue": "ICML 2023",
        "doi": None, "arxiv_id": "2301.12503",
...
for p in PAPERS:
    ...
    cur.execute(
        ...
        "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
        (pid, p["title"], p["key_contributions"], p["summary"], p["abstract"],
         p["year"], p["citation_count"], p["venue"], p["doi"], p["arxiv_id"],
         p["fields_of_study"], min(p["citation_count"] / 100, 100.0), 0, "completed", now, now)
    )
    papers[key] = pid
    inserted_p += 1
...
RELATIONS = [
    ...
    #  Part 1: 语音AI知识节点内部关联
    # ═══════════════════════════════════════════════════════════
    (N.get("自动语音识别 (ASR)"), N.get("语音合成 (TTS)"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "ASR和TTS是语音处理的两大核心任务——互为逆过程：语音→文字 vs 文字→语音"),

    (N.get("CTC (连接时序分类)"), N.get("自动语音识别 (ASR)"),
     "ENABLES", "knowledge_node", "knowledge_node",
     "CTC解决了语音帧与文字的对齐问题，使端到端ASR成为可能"),

    (N.get("声码器 (Vocoder)"), N.get("语音合成 (TTS)"),
     "PART_OF", "knowledge_node", "knowledge_node",
     "声码器是TTS流水线的最后环节——将频谱特征转换为可播放的音频波形"),

    (N.get("神经音频编解码 (Neural Audio Codec)"), N.get("语音大模型 (Speech Foundation Model)"),
     "ENABLES", "knowledge_node", "knowledge_node",
     "音频编解码器将语音离散化为token，是语音大模型能用LM方式建模语音的关键"),

    (N.get("语音自监督学习"), N.get("自动语音识别 (ASR)"),
     "IMPROVES", "knowledge_node", "knowledge_node",
     "自监督预训练大幅减少ASR对标注数据的依赖——10分钟标注即可达到传统效果"),

    (N.get("语音自监督学习"), N.get("语音合成 (TTS)"),
     "IMPROVES", "knowledge_node", "knowledge_node",
     "自监督语音表示也可用于TTS的说话人建模和韵律建模"),

    (N.get("语音大模型 (Speech Foundation Model)"), N.get("自动语音识别 (ASR)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "语音大模型（如Whisper）在ASR任务上展现出惊人的零样本泛化能力"),

    (N.get("语音大模型 (Speech Foundation Model)"), N.get("语音合成 (TTS)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "语音大模型（如VALL-E）将TTS重新定义为语言建模任务"),

    (N.get("零样本语音克隆 (Zero-shot Voice Cloning)"), N.get("语音合成 (TTS)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "零样本语音克隆是TTS的前沿方向——无需微调即可复制任意人声"),

    (N.get("零样本语音克隆 (Zero-shot Voice Cloning)"), N.get("神经音频编解码 (Neural Audio Codec)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "语音克隆模型通常基于神经编解码器的离散表示来建模说话人特征"),

    (N.get("音频生成 (Audio Generation)"), N.get("语音合成 (TTS)"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "TTS是音频生成的核心子任务，音频生成还包括音乐/音效生成"),

    (N.get("Conformer (卷积+Transformer)"), N.get("自动语音识别 (ASR)"),
     "IMPROVES", "knowledge_node", "knowledge_node",
     "Conformer是工业级ASR系统的标准架构——CNN局部+Transformer全局"),

    (N.get("说话人验证与声纹识别"), N.get("零样本语音克隆 (Zero-shot Voice Cloning)"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "声纹识别提取的说话人嵌入是语音克隆中条件生成的关键输入"),

    (N.get("语音情感识别 (SER)"), N.get("自动语音识别 (ASR)"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
    ...
    #  Part 2: 论文↔知识节点关联
    # ═══════════════════════════════════════════════════════════
    (P.get("WaveNet"), N.get("声码器 (Vocoder)"),
     "RELATED_TO", "paper", "knowledge_node",
     "WaveNet开创了神经声码器时代——直接从特征生成原始音频波形"),

    (P.get("WaveNet"), N.get("语音合成 (TTS)"),
     "RELATED_TO", "paper", "knowledge_node",
     "WaveNet是TTS领域里程碑式的工作，语音质量远超传统方法"),

    (P.get("Tacotron 2"), N.get("语音合成 (TTS)"),
     "RELATED_TO", "paper", "knowledge_node",
     "Tacotron 2是端到端TTS的经典工作——接近人类语音质量的MOS 4.53"),

    (P.get("Tacotron 2"), P.get("WaveNet"),
     "BUILDS_ON", "paper", "paper",
     "Tacotron 2使用WaveNet作为声码器生成最终波形"),

    (P.get("Wav2Vec 2.0"), N.get("语音自监督学习"),
     "RELATED_TO", "paper", "knowledge_node",
     "Wav2Vec 2.0是语音自监督学习的奠基性工作——对比学习+量化"),

    (P.get("HuBERT"), N.get("语音自监督学习"),
     "RELATED_TO", "paper", "knowledge_node",
     "HuBERT用掩码预测离散聚类标签，是Wav2Vec 2.0的重要改进"),

    (P.get("HuBERT"), P.get("Wav2Vec 2.0"),
     "IMPROVES", "paper", "paper",
     "HuBERT改进了Wav2Vec 2.0的训练方式——用离线聚类代替在线量化"),

    (P.get("Whisper"), N.get("自动语音识别 (ASR)"),
     "RELATED_TO", "paper", "knowledge_node",
     "Whisper在68万小时数据上训练，是ASR领域的里程碑大模型"),

    (P.get("Whisper"), N.get("语音大模型 (Speech Foundation Model)"),
     "RELATED_TO", "paper", "knowledge_node",
     "Whisper展示了大规模弱监督训练在语音识别中的巨大潜力"),

    (P.get("Conformer"), N.get("Conformer (卷积+Transformer)"),
     "RELATED_TO", "paper", "knowledge_node",
     "Conformer论文提出了这一CNN+Transformer混合架构"),

    (P.get("AudioLM"), N.get("语音大模型 (Speech Foundation Model)"),
     "RELATED_TO", "paper", "knowledge_node",
     "AudioLM开创性地将语音建模为token序列→语言模型自回归生成"),

    (P.get("AudioLM"), N.get("音频生成 (Audio Generation)"),
     "RELATED_TO", "paper", "knowledge_node",
     "AudioLM是音频生成领域的里程碑——不依赖文本即可生成连贯音频"),

    (P.get("VALL-E"), N.get("零样本语音克隆 (Zero-shot Voice Cloning)"),
     "RELATED_TO", "paper", "knowledge_node",
     "VALL-E首次实现了3秒prompt的零样本语音克隆——TTS的GPT时刻"),

    (P.get("VALL-E"), N.get("语音大模型 (Speech Foundation Model)"),
     "RELATED_TO", "paper", "knowledge_node",
     "VALL-E将TTS重定义为神经编解码语言模型——语音合成的新范式"),

    (P.get("VALL-E"), P.get("EnCodec"),
     "BUILDS_ON", "paper", "paper",
     "VALL-E使用EnCodec的离散音频token作为建模目标"),

    (P.get("VALL-E"), P.get("AudioLM"),
     "BUILDS_ON", "paper", "paper",
     "VALL-E借鉴AudioLM的语言建模思路，但增加了文本条件输入"),

    (P.get("EnCodec"), N.get("神经音频编解码 (Neural Audio Codec)"),
     "RELATED_TO", "paper", "knowledge_node",
     "EnCodec是Meta的神经音频编解码器——VALL-E等语音大模型的基础"),

    (P.get("SoundStorm"), P.get("AudioLM"),
     "IMPROVES", "paper", "paper",
     "SoundStorm用并行解码替代AudioLM的自回归，速度快100倍"),

    (P.get("SoundStorm"), N.get("音频生成 (Audio Generation)"),
     "RELATED_TO", "paper", "knowledge_node",
     "SoundStorm实现了高效并行音频生成——解决自回归方法的速度瓶颈"),

    (P.get("DeepSpeech 2"), N.get("自动语音识别 (ASR)"),
     "RELATED_TO", "paper", "knowledge_node",
     "百度DeepSpeech 2是端到端ASR的里程碑——英语+普通话双语"),

    (P.get("DeepSpeech 2"), N.get("CTC (连接时序分类)"),
     "BUILDS_ON", "paper", "knowledge_node",
     "DeepSpeech 2使用CTC损失训练端到端ASR模型"),

    (P.get("HiFi-GAN"), N.get("声码器 (Vocoder)"),
     "RELATED_TO", "paper", "knowledge_node",
     "HiFi-GAN是目前最广泛使用的神经声码器——实时+高保真"),

    (P.get("GPT-SoVITS"), N.get("零样本语音克隆 (Zero-shot Voice Cloning)"),
     "RELATED_TO", "paper", "knowledge_node",
     "GPT-SoVITS是开源社区最受欢迎的语音克隆工具——40K+ Stars"),

    (P.get("CosyVoice"), N.get("零样本语音克隆 (Zero-shot Voice Cloning)"),
     "RELATED_TO", "paper", "knowledge_node",
     "CosyVoice用监督语义token+流匹配实现多语言零样本TTS"),

    (P.get("CosyVoice"), P.get("VALL-E"),
     "BUILDS_ON", "paper", "paper",
     "CosyVoice改进了VALL-E的思路——用监督语义token替代无监督离散化"),

    (P.get("ChatTTS"), N.get("语音合成 (TTS)"),
     "RELATED_TO", "paper", "knowledge_node",
     "ChatTTS专注于对话场景的中文语音生成——可控韵律+笑声/停顿"),

    (P.get("Fish Speech"), N.get("语音合成 (TTS)"),
     "RELATED_TO", "paper", "knowledge_node",
     "Fish Speech是基于VITS2的开源多语言TTS——低延迟工业级方案"),

    (P.get("Voicebox"), N.get("音频生成 (Audio Generation)"),
     "RELATED_TO", "paper", "knowledge_node",
     "Voicebox用流匹配实现通用语音生成——支持克隆/编辑/降噪等多任务"),

    (P.get("AudioLDM"), N.get("音频生成 (Audio Generation)"),
     "RELATED_TO", "paper", "knowledge_node",
    ...
    #  Part 3: 论文之间的关联
    # ═══════════════════════════════════════════════════════════
    (P.get("Whisper"), P.get("Wav2Vec 2.0"),
     "RELATED_TO", "paper", "paper",
     "两条不同路线的大规模ASR：Whisper=弱监督, Wav2Vec=自监督"),

    (P.get("Whisper"), P.get("Conformer"),
     "BUILDS_ON", "paper", "paper",
     "Whisper的编码器使用了类似Conformer的架构设计"),

    (P.get("GPT-SoVITS"), P.get("VALL-E"),
     "BUILDS_ON", "paper", "paper",
     "GPT-SoVITS借鉴VALL-E的语言模型思路，用GPT控制语音生成"),

    (P.get("AudioLDM"), P.get("AudioLM"),
     "RELATED_TO", "paper", "paper",
     "两条音频生成路线：AudioLM=自回归token模型, AudioLDM=潜在扩散模型"),

    (P.get("Voicebox"), P.get("VALL-E"),
     "RELATED_TO", "paper", "paper",
     "两条TTS路线：VALL-E=自回归语言模型, Voicebox=流匹配非自回归"),

    (P.get("HiFi-GAN"), P.get("WaveNet"),
     "IMPROVES", "paper", "paper",
     "HiFi-GAN用GAN替代自回归——实时速度+接近WaveNet的质量"),

    (P.get("HiFi-GAN"), P.get("Tacotron 2"),
     "RELATED_TO", "paper", "paper",
    ...
    # ═══════════════════════════════════════════════════════════
    (N.get("Conformer (卷积+Transformer)"), N.get("Transformer 架构"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "Conformer在Transformer基础上融合了卷积模块，专为语音设计"),

    (N.get("Conformer (卷积+Transformer)"), N.get("卷积神经网络 (CNN)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "Conformer结合CNN的局部特征提取能力处理语音的短时特征"),

    (N.get("语音大模型 (Speech Foundation Model)"), N.get("大语言模型 (LLM)"),
     "ANALOGOUS_TO", "knowledge_node", "knowledge_node",
     "语音大模型借鉴LLM的思路：大规模预训练→通用能力→下游适配"),

    (N.get("语音大模型 (Speech Foundation Model)"), N.get("Scaling Law (规模定律)"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "Whisper验证了Scaling Law在语音领域同样成立——更多数据=更强泛化"),

    (N.get("神经音频编解码 (Neural Audio Codec)"), N.get("变分自编码器 (VAE)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "神经音频编解码器使用VQ-VAE/残差向量量化将音频压缩为离散token"),

    (N.get("语音自监督学习"), N.get("自监督学习 (Self-Supervised Learning)"),
     "PART_OF", "knowledge_node", "knowledge_node",
     "语音自监督学习是自监督学习在语音领域的应用——从无标注语音学表示"),

    (N.get("语音自监督学习"), N.get("对比学习 (Contrastive Learning)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "Wav2Vec 2.0使用对比学习作为语音自监督的核心目标"),

    (N.get("语音自监督学习"), N.get("预训练-微调范式"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "语音自监督→预训练→微调 = NLP的BERT范式在语音领域的复现"),

    (N.get("零样本语音克隆 (Zero-shot Voice Cloning)"), N.get("上下文学习 (In-Context Learning)"),
     "ANALOGOUS_TO", "knowledge_node", "knowledge_node",
     "3秒音频prompt → 生成该人声音，类似LLM的few-shot in-context learning"),

    (N.get("CTC (连接时序分类)"), N.get("循环神经网络 (RNN/LSTM)"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "CTC最初与LSTM-RNN结合使用，实现端到端的序列到序列映射"),

    (N.get("音频生成 (Audio Generation)"), N.get("扩散模型 (Diffusion Models)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "AudioLDM等用扩散模型生成音频——图像扩散思路到音频的迁移"),

    (N.get("音频生成 (Audio Generation)"), N.get("自回归生成模型"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "AudioLM用自回归方式逐token生成音频——语言模型思路的音频版"),

    (P.get("HiFi-GAN"), N.get("生成对抗网络 (GAN)"),
     "BUILDS_ON", "paper", "knowledge_node",
     "HiFi-GAN将GAN应用于声码器——对抗训练生成高保真音频"),

    (P.get("AudioLDM"), N.get("扩散模型 (Diffusion Models)"),
     "BUILDS_ON", "paper", "knowledge_node",
     "AudioLDM = 潜在扩散模型(Stable Diffusion思路) + 音频生成"),

    (P.get("Wav2Vec 2.0"), N.get("对比学习 (Contrastive Learning)"),
     "BUILDS_ON", "paper", "knowledge_node",
     "Wav2Vec 2.0用对比学习目标训练语音表示——正例=同一帧量化后的码本"),

    (P.get("VALL-E"), N.get("大语言模型 (LLM)"),
     "ANALOGOUS_TO", "paper", "knowledge_node",
     "VALL-E将TTS重定义为语言建模——编解码token上的自回归生成，类比GPT"),

    (P.get("VALL-E"), N.get("上下文学习 (In-Context Learning)"),
     "RELATED_TO", "paper", "knowledge_node",
    ...
    #  Part 5: 跨领域关联
    # ═══════════════════════════════════════════════════════════
    (N.get("语音情感识别 (SER)"), N.get("巴甫洛夫条件反射"),
     "ANALOGOUS_TO", "knowledge_node", "knowledge_node",
     "情感信号是条件化的声学线索——语音中的情感特征(F0、语速)与情感状态的关联类似条件反射") if N.get("巴甫洛夫条件反射") else None,

    (N.get("声码器 (Vocoder)"), N.get("傅里叶变换"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "声码器处理梅尔频谱(频域)→波形(时域)的变换，与傅里叶变换的时频变换密切相关") if N.get("傅里叶变换") else None,

    (N.get("语音大模型 (Speech Foundation Model)"), N.get("涌现能力 (Emergent Abilities)"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "Whisper/VALL-E展示了类似LLM的涌现能力——规模增大后出现零样本跨语言/跨说话人能力"),

    (N.get("多模态学习 (Multimodal Learning)"), N.get("语音大模型 (Speech Foundation Model)"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "GPT-4o将语音理解/生成集成到多模态LLM中——语音成为多模态的重要模态"),

    (N.get("自动语音识别 (ASR)"), N.get("注意力机制"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
