...
NODES = [
    # ── 生物学 ──
    {
        "id": gen_id(), "name": "自然选择与进化",
        "node_type": "phenomenon", "domain": "biology",
        ...
        "year": 1859, "tags": "进化,自然选择,适者生存,达尔文,变异,遗传",
    },
    {
        "id": gen_id(), "name": "蚁群觅食行为",
        "node_type": "phenomenon", "domain": "biology",
        ...
        "year": None, "tags": "蚁群,信息素,分布式智能,集群行为,正反馈",
    },
    {
        "id": gen_id(), "name": "免疫系统应答",
        "node_type": "process", "domain": "biology",
        ...
        "year": 1957, "tags": "免疫,抗体,克隆选择,亲和力成熟,免疫记忆",
    },
    {
        "id": gen_id(), "name": "神经突触传导",
        "node_type": "process", "domain": "neuroscience",
        ...
        "year": 1949, "tags": "神经元,突触,赫布学习,突触可塑性,神经递质",
    },
    {
        "id": gen_id(), "name": "基因表达与调控",
        "node_type": "process", "domain": "biology",
        ...
        "year": 1958, "tags": "基因,DNA,转录,翻译,表观遗传,中心法则",
    },

    # ── 物理学 ──
    {
        "id": gen_id(), "name": "金属退火过程",
        "node_type": "phenomenon", "domain": "physics",
        "description": "将金属加热到高温后缓慢冷却，原子获得足够能量跳出局部能量陷阱，"
                       "逐步找到更低能量的晶体排列。温度越高原子越活跃，"
                       "冷却越慢越能找到全局最优结构。",
        "summary": "高温给原子逃离局部陷阱的能量，缓慢冷却找到全局最优",
        "source_info": "冶金学经典工艺",
        "year": None, "tags": "退火,冶金,能量最小化,相变,结晶",
    },
    {
        "id": gen_id(), "name": "最小作用量原理",
        "node_type": "principle", "domain": "physics",
        ...
        "year": 1744, "tags": "作用量,拉格朗日,变分法,优化,最优路径",
    },
    {
        "id": gen_id(), "name": "热力学第二定律（熵增）",
        "node_type": "law", "domain": "physics",
        ...
        "year": 1850, "tags": "熵,热力学,信息论,无序,概率",
    },
    {
        "id": gen_id(), "name": "反馈控制（负反馈）",
        "node_type": "principle", "domain": "engineering",
        ...
        "year": 1788, "tags": "反馈,PID,控制论,误差修正,自动控制",
    },

    # ── 数学 ──
    {
        "id": gen_id(), "name": "贝叶斯定理",
        "node_type": "theorem", "domain": "mathematics",
        ...
        "year": 1763, "tags": "贝叶斯,概率,后验,先验,推理,统计",
    },
    {
        "id": gen_id(), "name": "梯度下降法",
        "node_type": "method", "domain": "mathematics",
        ...
        "year": 1847, "tags": "梯度,优化,SGD,Adam,深度学习,凸优化",
    },
    {
        "id": gen_id(), "name": "图论与网络科学",
        "node_type": "concept", "domain": "mathematics",
        ...
        "year": 1736, "tags": "图论,网络,小世界,度分布,图神经网络",
    },
    ...
    # ── 计算机科学（方法） ──
    {
        ...
        "year": 1975, "tags": "遗传算法,进化计算,选择,交叉,变异,优化",
    },
    {
        "id": gen_id(), "name": "蚁群优化算法",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 1992, "tags": "蚁群算法,信息素,TSP,群体智能,组合优化",
    },
    {
        "id": gen_id(), "name": "模拟退火算法",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 1983, "tags": "模拟退火,Metropolis,温度调度,全局优化,随机搜索",
    },
    {
        "id": gen_id(), "name": "人工神经网络",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 1943, "tags": "神经网络,感知机,反向传播,深度学习,激活函数",
    },
    {
        "id": gen_id(), "name": "人工免疫算法",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 1986, "tags": "人工免疫,克隆选择,负选择,异常检测,网络安全",
    },
    {
        "id": gen_id(), "name": "注意力机制",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2014, "tags": "注意力,Transformer,自注意力,Seq2Seq,选择性关注",
    },
    {
        "id": gen_id(), "name": "信息熵与交叉熵",
        ...
        "year": 1948, "tags": "信息熵,交叉熵,Shannon,损失函数,KL散度",
    },

    # ── 经济学/博弈论 ──
    {
        "id": gen_id(), "name": "纳什均衡",
        "node_type": "theorem", "domain": "economics",
        ...
        "year": 1950, "tags": "博弈论,纳什均衡,GAN,对抗,策略",
    },
]
...
for n in NODES:
    # 检查是否已存在
    existing = cur.execute("SELECT id FROM knowledge_nodes WHERE name = ?", (n["name"],)).fetchone()
    if existing:
    ...
    cur.execute(
        ...
        "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
        (n["id"], n["name"], n["node_type"], n["domain"], n["description"],
