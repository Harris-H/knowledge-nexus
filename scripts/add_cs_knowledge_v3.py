...
NODES = [
    ...
    {
        "name": "深度学习",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2006, "tags": "深度学习,deep learning,表示学习,Hinton,多层网络",
    },
    {
        "name": "反向传播算法",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 1986, "tags": "反向传播,backpropagation,链式法则,梯度,自动微分",
    },
    {
        "name": "卷积神经网络 (CNN)",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 1998, "tags": "CNN,卷积,视觉,特征提取,ResNet,AlexNet",
    },
    {
        ...
        "year": 1997, "tags": "RNN,LSTM,GRU,序列,时序,梯度消失,门控",
    },
    {
        "name": "梯度下降与优化器",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2014, "tags": "梯度下降,SGD,Adam,优化器,学习率,momentum",
    },
    {
        ...
        "year": 2015, "tags": "BatchNorm,归一化,LayerNorm,训练稳定,协变量偏移",
    },
    {
        "name": "Dropout 正则化",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2014, "tags": "Dropout,正则化,过拟合,ensemble,随机失活",
    },
    {
        "name": "残差连接 (ResNet)",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2015, "tags": "ResNet,残差连接,skip connection,深层网络,退化问题",
    },
    ...
    # ═══════════ Transformer 与 NLP 革命 ═══════════
    {
        ...
        "year": 2017, "tags": "Transformer,自注意力,多头注意力,位置编码,并行计算",
    },
    {
        ...
        "year": 2017, "tags": "自注意力,QKV,多头注意力,全局依赖,softmax",
    },
    {
        ...
        "year": 2013, "tags": "Word2Vec,词嵌入,GloVe,语义空间,分布式表示",
    },
    {
        ...
        "year": 2017, "tags": "位置编码,RoPE,正弦编码,ALiBi,旋转位置编码",
    },

    # ═══════════ 大语言模型 (LLM) 生态 ═══════════
    {
        "name": "大语言模型 (LLM)",
        "node_type": "concept", "domain": "computer_science",
        ...
        "year": 2020, "tags": "LLM,GPT,ChatGPT,大模型,Scaling Law,通用AI",
    },
    {
        "name": "预训练-微调范式",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2018, "tags": "预训练,微调,BERT,LoRA,Prompt Tuning,参数高效",
    },
    {
        "name": "Scaling Law (规模定律)",
        "node_type": "principle", "domain": "computer_science",
        ...
        "year": 2020, "tags": "Scaling Law,幂律,Chinchilla,算力,参数量,数据量",
    },
    {
        "name": "涌现能力 (Emergent Abilities)",
        "node_type": "phenomenon", "domain": "computer_science",
        ...
        "year": 2022, "tags": "涌现,相变,规模效应,突变,少样本学习,推理能力",
    },
    {
        ...
        "year": 2020, "tags": "ICL,上下文学习,少样本,prompt,隐式学习,GPT-3",
    },
    {
        "name": "RLHF (人类反馈强化学习)",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2022, "tags": "RLHF,对齐,alignment,PPO,DPO,人类反馈,ChatGPT",
    },
    {
        ...
        "year": 2022, "tags": "CoT,思维链,推理,提示工程,Tree of Thought,step by step",
    },
    {
        ...
        "year": 2021, "tags": "提示工程,prompt,Few-shot,Zero-shot,角色扮演,系统提示",
    },
    {
        "name": "检索增强生成 (RAG)",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2020, "tags": "RAG,检索增强,向量数据库,幻觉,知识库,Embedding",
    },
    {
        "name": "混合专家模型 (MoE)",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2017, "tags": "MoE,混合专家,稀疏激活,Mixtral,Switch Transformer",
    },
    ...
    # ═══════════ AI Agent 与工具使用 ═══════════
    {
        ...
        "year": 2023, "tags": "Agent,智能体,自主,AutoGPT,规划,工具使用,行动",
    },
    {
        ...
        "year": 2024, "tags": "MCP,协议,工具连接,Anthropic,标准化,Client-Server",
    },
    {
        ...
        "year": 2023, "tags": "Function Calling,函数调用,工具使用,API,JSON Schema",
    },
    {
        ...
        "year": 2023, "tags": "多Agent,Multi-Agent,MetaGPT,AutoGen,协作,分工",
    },
    {
        "name": "ReAct 框架",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2022, "tags": "ReAct,推理,行动,Agent,LangChain,Thought-Action",
    },
    {
        ...
        "year": 2012, "tags": "知识图谱,KG,实体,关系,Neo4j,知识推理",
    },
    ...
    # ═══════════ 生成模型 ═══════════
    {
        ...
        "year": 2014, "tags": "GAN,生成对抗,生成器,判别器,对抗训练,纳什均衡",
    },
    {
        "name": "变分自编码器 (VAE)",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2013, "tags": "VAE,变分推断,潜在空间,ELBO,自编码器,生成",
    },
    {
        ...
        "year": 2020, "tags": "扩散模型,DDPM,Stable Diffusion,去噪,Sora,图像生成",
    },
    {
        "name": "自回归生成模型",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2018, "tags": "自回归,next token prediction,GPT,采样,Beam Search",
    },
    ...
    # ═══════════ 学习范式 ═══════════
    {
        ...
        "year": 2020, "tags": "对比学习,SimCLR,MoCo,CLIP,自监督,表示学习",
    },
    {
        ...
        "year": 2019, "tags": "自监督,SSL,MAE,MLM,pretext task,无标注",
    },
    {
        ...
        "year": 2015, "tags": "知识蒸馏,teacher,student,模型压缩,软标签,部署",
    },
    {
        ...
        "year": 2017, "tags": "联邦学习,隐私保护,分布式,数据孤岛,GDPR,聚合",
    },
    {
        ...
        "year": 2021, "tags": "多模态,CLIP,GPT-4V,Sora,文生图,模态对齐",
    },
    {
        "name": "图神经网络 (GNN)",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2017, "tags": "GNN,图神经网络,GCN,GAT,消息传递,图学习",
    },
    {
        "name": "量化与模型压缩",
        "node_type": "method", "domain": "computer_science",
        ...
        "year": 2022, "tags": "量化,INT4,GPTQ,AWQ,模型压缩,剪枝,gguf",
    },
]
...
for n in NODES:
    ...
    cur.execute(
        ...
        "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
        (nid, n["name"], n["node_type"], n["domain"], n["description"],
         n["summary"], n["source_info"], n["year"], n["tags"], now, now)
    )
    node_ids[n["name"]] = nid
    inserted += 1
...
RELATIONS = [
    ...
    #  Part 1: 深度学习基础内部关联
    # ═══════════════════════════════════════════════════════════
    (N.get("反向传播算法"), N.get("人工神经网络"),
     "ENABLES", "knowledge_node", "knowledge_node",
     "反向传播是训练多层神经网络的核心算法，使深度学习成为可能"),

    (N.get("梯度下降与优化器"), N.get("反向传播算法"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "反向传播计算梯度，梯度下降利用梯度更新参数——二者缺一不可"),

    (N.get("深度学习"), N.get("人工神经网络"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "深度学习是多层神经网络的现代化实践，本质上是'深层'的神经网络"),

    (N.get("深度学习"), N.get("反向传播算法"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "反向传播是深度学习训练的基础引擎"),

    (N.get("卷积神经网络 (CNN)"), N.get("深度学习"),
     "PART_OF", "knowledge_node", "knowledge_node",
     "CNN是深度学习中处理视觉数据的核心架构"),

    (N.get("循环神经网络 (RNN/LSTM)"), N.get("深度学习"),
     "PART_OF", "knowledge_node", "knowledge_node",
     "RNN/LSTM是深度学习中处理序列数据的经典架构"),

    (N.get("批量归一化 (Batch Normalization)"), N.get("深度学习"),
     "IMPROVES", "knowledge_node", "knowledge_node",
     "BN使深度网络训练更稳定、更快收敛"),

    (N.get("Dropout 正则化"), N.get("深度学习"),
     "IMPROVES", "knowledge_node", "knowledge_node",
     "Dropout通过随机丢弃防止深度网络过拟合"),

    (N.get("残差连接 (ResNet)"), N.get("深度学习"),
     "IMPROVES", "knowledge_node", "knowledge_node",
     "残差连接突破了深层网络的退化瓶颈，使超深网络成为可能"),

    (N.get("残差连接 (ResNet)"), N.get("卷积神经网络 (CNN)"),
     "IMPROVES", "knowledge_node", "knowledge_node",
    ...
    # ═══════════════════════════════════════════════════════════
    (N.get("Transformer 架构"), N.get("注意力机制"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "Transformer将注意力从辅助机制升级为核心架构——'Attention Is All You Need'"),

    (N.get("自注意力机制 (Self-Attention)"), N.get("注意力机制"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "自注意力是注意力机制的自回指版本，序列内部互相关注"),

    (N.get("Transformer 架构"), N.get("自注意力机制 (Self-Attention)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "多头自注意力是Transformer的核心组件"),

    (N.get("Transformer 架构"), N.get("残差连接 (ResNet)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "Transformer每个子层都使用残差连接+LayerNorm"),

    (N.get("Transformer 架构"), N.get("位置编码 (Positional Encoding)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "位置编码弥补了自注意力的位置无关性"),

    (N.get("Transformer 架构"), N.get("循环神经网络 (RNN/LSTM)"),
     "IMPROVES", "knowledge_node", "knowledge_node",
     "Transformer用并行注意力取代了RNN的递归结构，训练效率大幅提升"),

    (N.get("词嵌入 (Word Embedding)"), N.get("Transformer 架构"),
     "ENABLES", "knowledge_node", "knowledge_node",
    ...
    #  Part 3: LLM 生态系统
    # ═══════════════════════════════════════════════════════════
    (N.get("大语言模型 (LLM)"), N.get("Transformer 架构"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "LLM基于Transformer架构(通常是decoder-only)构建"),

    (N.get("大语言模型 (LLM)"), N.get("预训练-微调范式"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "LLM的训练流程：大规模预训练→指令微调→RLHF对齐"),

    (N.get("大语言模型 (LLM)"), N.get("自回归生成模型"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "GPT系列LLM本质上是自回归语言模型——逐token预测下一个"),

    (N.get("大语言模型 (LLM)"), N.get("Scaling Law (规模定律)"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "Scaling Law指导了LLM的训练策略——更大模型+更多数据=更强能力"),

    (N.get("涌现能力 (Emergent Abilities)"), N.get("大语言模型 (LLM)"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "涌现能力是LLM规模增长后的惊人副产物"),

    (N.get("上下文学习 (In-Context Learning)"), N.get("大语言模型 (LLM)"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "ICL是GPT-3展示的核心涌现能力——不改权重就能学新任务"),

    (N.get("预训练-微调范式"), N.get("迁移学习"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "预训练-微调是迁移学习在深度学习时代最成功的实践"),

    (N.get("RLHF (人类反馈强化学习)"), N.get("强化学习"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "RLHF将RL应用于LLM对齐：用人类偏好训练奖励模型+PPO优化"),

    (N.get("RLHF (人类反馈强化学习)"), N.get("大语言模型 (LLM)"),
     "IMPROVES", "knowledge_node", "knowledge_node",
     "RLHF是ChatGPT对齐的关键技术——让LLM更有帮助、更安全"),

    (N.get("思维链推理 (Chain of Thought)"), N.get("大语言模型 (LLM)"),
     "IMPROVES", "knowledge_node", "knowledge_node",
     "CoT提示让LLM展开推理过程，大幅提升数学和逻辑推理能力"),

    (N.get("思维链推理 (Chain of Thought)"), N.get("提示工程 (Prompt Engineering)"),
     "PART_OF", "knowledge_node", "knowledge_node",
     "CoT是提示工程中最重要的技术之一"),

    (N.get("提示工程 (Prompt Engineering)"), N.get("上下文学习 (In-Context Learning)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "提示工程的理论基础是ICL——通过精心设计prompt引导模型行为"),

    (N.get("检索增强生成 (RAG)"), N.get("大语言模型 (LLM)"),
     "IMPROVES", "knowledge_node", "knowledge_node",
     "RAG通过检索外部知识解决LLM的幻觉和知识过时问题"),

    (N.get("检索增强生成 (RAG)"), N.get("知识图谱 (Knowledge Graph)"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "RAG+KG：知识图谱是RAG的高质量知识来源，结构化数据比文本检索更精确"),

    (N.get("混合专家模型 (MoE)"), N.get("大语言模型 (LLM)"),
     "IMPROVES", "knowledge_node", "knowledge_node",
     "MoE让LLM在保持推理效率的同时大幅增加参数量"),

    (N.get("混合专家模型 (MoE)"), N.get("Transformer 架构"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
    ...
    # ═══════════════════════════════════════════════════════════
    (N.get("AI Agent (智能体)"), N.get("大语言模型 (LLM)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "LLM是AI Agent的'大脑'——提供理解、推理和决策能力"),

    (N.get("AI Agent (智能体)"), N.get("Function Calling (函数调用)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "Function Calling是Agent使用工具的基础能力"),

    (N.get("AI Agent (智能体)"), N.get("ReAct 框架"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "ReAct的推理+行动循环是Agent框架的底层模式"),

    (N.get("MCP (Model Context Protocol)"), N.get("AI Agent (智能体)"),
     "IMPROVES", "knowledge_node", "knowledge_node",
     "MCP标准化了Agent与工具的连接方式——Agent生态的'USB协议'"),

    (N.get("MCP (Model Context Protocol)"), N.get("Function Calling (函数调用)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "MCP在Function Calling基础上提供了标准化的Client-Server协议"),

    (N.get("多Agent系统 (Multi-Agent)"), N.get("AI Agent (智能体)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "多Agent系统由多个Agent协作组成，涌现集体智慧"),

    (N.get("ReAct 框架"), N.get("思维链推理 (Chain of Thought)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "ReAct = CoT(推理能力) + 工具使用(行动能力)的结合"),

    (N.get("Function Calling (函数调用)"), N.get("大语言模型 (LLM)"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
    ...
    #  Part 5: 生成模型家族
    # ═══════════════════════════════════════════════════════════
    (N.get("生成对抗网络 (GAN)"), N.get("深度学习"),
     "PART_OF", "knowledge_node", "knowledge_node",
     "GAN是深度学习中的经典生成模型框架"),

    (N.get("变分自编码器 (VAE)"), N.get("深度学习"),
     "PART_OF", "knowledge_node", "knowledge_node",
     "VAE是深度学习中的概率生成模型"),

    (N.get("扩散模型 (Diffusion Models)"), N.get("深度学习"),
     "PART_OF", "knowledge_node", "knowledge_node",
     "扩散模型是深度学习中最新的生成模型范式"),

    (N.get("扩散模型 (Diffusion Models)"), N.get("变分自编码器 (VAE)"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "扩散模型的数学推导与VAE有深层联系，DDPM可以看作特殊的层级VAE"),

    (N.get("扩散模型 (Diffusion Models)"), N.get("生成对抗网络 (GAN)"),
     "IMPROVES", "knowledge_node", "knowledge_node",
     "扩散模型在图像生成质量上超越了GAN，且训练更稳定"),

    (N.get("自回归生成模型"), N.get("大语言模型 (LLM)"),
     "ENABLES", "knowledge_node", "knowledge_node",
    ...
    #  Part 6: 学习范式与方法
    # ═══════════════════════════════════════════════════════════
    (N.get("自监督学习 (Self-Supervised Learning)"), N.get("预训练-微调范式"),
     "ENABLES", "knowledge_node", "knowledge_node",
     "预训练阶段本质上就是自监督学习——从海量无标注数据学习表示"),

    (N.get("对比学习 (Contrastive Learning)"), N.get("自监督学习 (Self-Supervised Learning)"),
     "PART_OF", "knowledge_node", "knowledge_node",
     "对比学习是自监督学习的核心方法之一"),

    (N.get("对比学习 (Contrastive Learning)"), N.get("多模态学习 (Multimodal Learning)"),
     "ENABLES", "knowledge_node", "knowledge_node",
     "CLIP用对比学习将图像和文本对齐到同一空间，开创多模态新范式"),

    (N.get("知识蒸馏 (Knowledge Distillation)"), N.get("量化与模型压缩"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "蒸馏压缩知识结构，量化压缩数值精度——两种互补的模型压缩方案"),

    (N.get("知识蒸馏 (Knowledge Distillation)"), N.get("迁移学习"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "蒸馏是一种特殊的迁移学习：从大模型(teacher)到小模型(student)迁移知识"),

    (N.get("多模态学习 (Multimodal Learning)"), N.get("大语言模型 (LLM)"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "GPT-4V、Gemini等多模态大模型在LLM基础上扩展视觉/音频理解能力"),

    (N.get("图神经网络 (GNN)"), N.get("知识图谱 (Knowledge Graph)"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "GNN在知识图谱上做链接预测、实体分类——图结构的天然搭档"),

    (N.get("图神经网络 (GNN)"), N.get("深度学习"),
     "PART_OF", "knowledge_node", "knowledge_node",
     "GNN是深度学习在图结构数据上的扩展"),

    (N.get("联邦学习 (Federated Learning)"), N.get("深度学习"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "联邦学习解决深度学习训练中的数据隐私问题——数据不动模型动"),

    (N.get("量化与模型压缩"), N.get("大语言模型 (LLM)"),
     "IMPROVES", "knowledge_node", "knowledge_node",
    ...
    #  Part 7: 与已有论文的关联
    # ═══════════════════════════════════════════════════════════
    (N.get("Transformer 架构"), P.get("Attention Is All You Need"),
     "RELATED_TO", "knowledge_node", "paper",
     "Transformer架构的奠基论文"),

    (N.get("Transformer 架构"), P.get("ViT"),
     "ENABLES", "knowledge_node", "paper",
     "ViT将Transformer从NLP迁移到计算机视觉"),

    (N.get("Transformer 架构"), P.get("Swin Transformer"),
     "ENABLES", "knowledge_node", "paper",
     "Swin Transformer用层级化窗口注意力改进了ViT"),

    (N.get("自注意力机制 (Self-Attention)"), P.get("Attention Is All You Need"),
     "RELATED_TO", "knowledge_node", "paper",
     "该论文首次将自注意力作为核心架构（而非辅助增强）"),

    (N.get("预训练-微调范式"), P.get("BERT"),
     "RELATED_TO", "knowledge_node", "paper",
     "BERT开创了NLP预训练-微调范式"),

    (N.get("自监督学习 (Self-Supervised Learning)"), P.get("BERT"),
     "RELATED_TO", "knowledge_node", "paper",
     "BERT的MLM和NSP都是自监督学习任务"),

    (N.get("自监督学习 (Self-Supervised Learning)"), P.get("MAE"),
     "RELATED_TO", "knowledge_node", "paper",
     "MAE将掩码自监督学习从NLP扩展到计算机视觉"),

    (N.get("对比学习 (Contrastive Learning)"), P.get("SimCLR"),
     "RELATED_TO", "knowledge_node", "paper",
     "SimCLR是对比学习的标志性工作——简单框架，强大效果"),

    (N.get("扩散模型 (Diffusion Models)"), P.get("Stable Diffusion"),
     "ENABLES", "knowledge_node", "paper",
     "Stable Diffusion = 扩散模型 + VAE + CLIP 的工程化集大成"),

    (N.get("变分自编码器 (VAE)"), P.get("Stable Diffusion"),
     "ENABLES", "knowledge_node", "paper",
     "Stable Diffusion使用VAE将图像压缩到潜在空间再做扩散"),

    (N.get("生成对抗网络 (GAN)"), P.get("GAN"),
     "RELATED_TO", "knowledge_node", "paper",
     "GAN知识节点对应的原始论文"),

    (N.get("生成对抗网络 (GAN)"), P.get("DCGAN"),
     "RELATED_TO", "knowledge_node", "paper",
     "DCGAN引入卷积结构稳定GAN训练，是GAN实用化的关键一步"),

    (N.get("生成对抗网络 (GAN)"), P.get("SRGAN"),
     "RELATED_TO", "knowledge_node", "paper",
     "SRGAN将GAN应用于超分辨率——GAN的经典应用场景"),

    (N.get("残差连接 (ResNet)"), P.get("ResNet"),
     "RELATED_TO", "knowledge_node", "paper",
     "残差连接知识节点对应的原始论文"),

    (N.get("卷积神经网络 (CNN)"), P.get("CIFAR-10"),
     "RELATED_TO", "knowledge_node", "paper",
     "CIFAR-10是CNN性能评估的经典基准数据集"),

    (N.get("深度学习"), P.get("PyTorch"),
     "RELATED_TO", "knowledge_node", "paper",
     "PyTorch是最主流的深度学习框架"),

    (N.get("图神经网络 (GNN)"), P.get("DGCNN"),
     "RELATED_TO", "knowledge_node", "paper",
     "DGCNN是在点云上应用图卷积的代表工作"),

    (N.get("RLHF (人类反馈强化学习)"), P.get("AlphaFold"),
     "ANALOGOUS_TO", "knowledge_node", "paper",
     "AlphaFold的迭代结构预测过程融合了RL思想，RLHF在蛋白质设计中也有潜力"),

    # ═══════════════════════════════════════════════════════════
    #  Part 8: 与其他领域知识的跨域关联
    # ═══════════════════════════════════════════════════════════
    (N.get("涌现能力 (Emergent Abilities)"), N.get("涌现与还原论"),
     "ANALOGOUS_TO", "knowledge_node", "knowledge_node",
     "LLM的涌现能力与哲学/复杂系统中的涌现概念高度对应——整体大于部分之和"),

    (N.get("Scaling Law (规模定律)"), N.get("幂律分布"),
     "ANALOGOUS_TO", "knowledge_node", "knowledge_node",
     "Scaling Law本质是幂律关系L∝N^α，与物理/经济中的幂律分布同源") if N.get("幂律分布") else None,

    (N.get("联邦学习 (Federated Learning)"), N.get("六度分隔与小世界网络"),
     "ANALOGOUS_TO", "knowledge_node", "knowledge_node",
     "联邦学习的去中心化拓扑与小世界网络的信息传播模式有结构相似性") if N.get("六度分隔与小世界网络") else None,

    (N.get("多Agent系统 (Multi-Agent)"), N.get("捕食者-猎物动力学（Lotka-Volterra）"),
     "ANALOGOUS_TO", "knowledge_node", "knowledge_node",
     "多Agent的竞争与合作动力学类似生态系统中的种群互动模式") if N.get("捕食者-猎物动力学（Lotka-Volterra）") else None,

    (N.get("多Agent系统 (Multi-Agent)"), N.get("蚁群觅食行为"),
     "ANALOGOUS_TO", "knowledge_node", "knowledge_node",
     "蚂蚁社会的分工协作+信息素通讯 ↔ 多Agent的角色分配+消息传递") if N.get("蚁群觅食行为") else None,

    (N.get("知识蒸馏 (Knowledge Distillation)"), N.get("遗忘曲线与间隔重复"),
     "ANALOGOUS_TO", "knowledge_node", "knowledge_node",
     "师生模型的知识传递 ↔ 教学心理学中的知识传授与记忆巩固") if N.get("遗忘曲线与间隔重复") else None,

    (N.get("Dropout 正则化"), N.get("免疫系统自适应防御"),
     "ANALOGOUS_TO", "knowledge_node", "knowledge_node",
     "Dropout随机失活增强鲁棒性 ↔ 免疫系统通过多样化抗体增强防御") if N.get("免疫系统自适应防御") else None,

    (N.get("扩散模型 (Diffusion Models)"), N.get("热力学第二定律（熵增原理）"),
     "ANALOGOUS_TO", "knowledge_node", "knowledge_node",
     "正向扩散=熵增(数据→噪声)，反向去噪=局部熵减(噪声→数据)——热力学的AI映射") if N.get("热力学第二定律（熵增原理）") else None,

    (N.get("梯度下降与优化器"), N.get("最小作用量原理"),
     "ANALOGOUS_TO", "knowledge_node", "knowledge_node",
     "梯度下降沿最陡路径下降 ↔ 最小作用量原理：自然选择能量最低路径") if N.get("最小作用量原理") else None,

    (N.get("AI Agent (智能体)"), N.get("控制论（Cybernetics）"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "Agent的感知-规划-行动-反馈循环是控制论核心思想的现代AI实现") if N.get("控制论（Cybernetics）") else None,

    (N.get("生成对抗网络 (GAN)"), N.get("纳什均衡"),
     "RELATED_TO", "knowledge_node", "knowledge_node",
     "GAN训练的目标点是纳什均衡：生成器和判别器都无法单方面改进") if N.get("纳什均衡") else None,

    (N.get("对比学习 (Contrastive Learning)"), N.get("信息熵与交叉熵"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "对比学习的InfoNCE损失基于互信息最大化，与信息熵理论紧密关联"),

    (N.get("知识图谱 (Knowledge Graph)"), N.get("图论与网络科学"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "知识图谱是图论在知识表示领域的应用——节点=实体，边=关系") if N.get("图论与网络科学") else None,

    (N.get("自回归生成模型"), N.get("贝叶斯定理"),
     "BUILDS_ON", "knowledge_node", "knowledge_node",
     "自回归模型的链式条件概率分解P(x)=∏P(xi|x<i)根植于概率论/贝叶斯思想") if N.get("贝叶斯定理") else None,

    (N.get("词嵌入 (Word Embedding)"), N.get("傅里叶变换"),
     "ANALOGOUS_TO", "knowledge_node", "knowledge_node",
     "傅里叶将信号映射到频域 ↔ Word2Vec将词映射到语义空间——都是'表示变换'") if N.get("傅里叶变换") else None,

    (N.get("批量归一化 (Batch Normalization)"), N.get("反馈控制（负反馈）"),
     "ANALOGOUS_TO", "knowledge_node", "knowledge_node",
     "BN将层输入归一化到标准分布 ↔ 负反馈将系统输出稳定在目标值附近") if N.get("反馈控制（负反馈）") else None,
]
...
cs_count = c.execute("SELECT COUNT(*) FROM knowledge_nodes WHERE domain='computer_science'").fetchone()[0]
